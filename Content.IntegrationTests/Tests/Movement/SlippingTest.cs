...
public sealed class SlippingTest : MovementTest
{
    ...
    public async Task BananaSlipTest()
    {
        ...
        // await SetKey(EngineKeyFunctions.Walk, BoundKeyState.Down); - Stellar - walk by default
        ...
        await SetKey(EngineKeyFunctions.Walk, BoundKeyState.Down); // - Stellar - sprinting
